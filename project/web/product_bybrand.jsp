    ...
    <body>
        <%
            ...
            if(request.getParameter("brand_id")!=null){
                brand_id = (long) Long.parseLong(request.getParameter("brand_id"));
            }
            ...
            total = productDAO.countProductByBrand(brand_id);
            if(total<=8){
                firstResult = 1;
                maxResult = total;
            }else{
            ...
            ArrayList<Product>listProduct = productDAO.getListProductByBrand(
                    brand_id, firstResult, maxResult);
        %>
            ...
            <div class="container">
                <div class="content">
                    <div class="content-top">
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.jsp?productID=<%=p.getProductID()%>"><img  src="/project/images/<%=p.getProductImage()%>" alt="<%=p.getProductName()%>" /></a>	
                ...
                <ul class="start">
                    ...
                    <%for(int i = 1; i <=(total/8)+1;i++){%>
                        <li class="arrow"><a href="product_bybrand.jsp?brand_id=<%=brand_id%>&pages=<%=i%>"><%=i%></a></li>
                    <%}%>
