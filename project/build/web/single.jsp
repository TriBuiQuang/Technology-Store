            ...
            <div class="container">
                <div class="single">
                    <div class="col-md-9 top-in-single">
                        <div class="col-md-5 single-top">	
                            ...
                            <a href="optionallink.html">
                                <img class="etalage_thumb_image img-responsive" src="images/<%=product.getProductImage()%>" alt="" >
                            </a>
                    ...
                    <div class="content-top-in">
                        ...
                        <div class="fb-comments" data-href="http://localhost:8084/project/single.jsp?productID=<%=productID%>" data-numposts="5" width="100%"></div>
                </div>
                <div class="col-md-3">
